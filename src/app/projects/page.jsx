...
const featuredProject = {
  ...
  links: [
    {
      title: "GitHub",
      url: "https://github.com/alejandrocqvd/IDEA-MR-Room-Planner",
    },
  ],
  images: [
  ...
  techStack: [
    {
      name: "C#",
      image: "/skills/cs-logo.png",
      bgColour: "bg-[#2A2A2A]",
      rounded: 1,
    },
    {
      name: "Meta XR SDK",
      image: "/skills/meta-xr-sdk-logo.png",
      bgColour: "bg-[#373737]",
      rounded: 0,
    },
    {
      name: "Unity",
      image: "/skills/unity-logo.png",
      bgColour: "bg-[#454545]",
      rounded: 2,
    },
  ],
...
const projects = {
  nullus: {
    ...
    links: [{ title: "Website", url: "https://www.nullus.ca/" }],
    images: [
      "/work/nullus-img.png",
    ...
    techStack: [
      ...
      {
        name: "TypeScript",
        image: "/skills/typescript-logo.png",
        bgColour: "bg-[#242424]",
        rounded: 0,
      },
      {
  ...
  urbanSignal: {
    ...
    links: [
      {
        title: "GitHub",
        url: "https://github.com/alejandrocqvd/hack-the-change-2025-mobile",
      },
    ],
    images: [
    ...
    techStack: [
      ...
      {
        name: "PostgreSQL",
        image: "/skills/postgre-logo.png",
        bgColour: "bg-[#282828]",
        rounded: 0,
      },
      {
        name: "SupaBase",
        image: "/skills/supabase-logo.png",
        bgColour: "bg-[#363636]",
        rounded: 2,
      },
    ],
  ...
  malwareTerminal: {
    ...
    links: [
      {
        title: "GitHub",
        url: "https://github.com/your-username/malware-terminal",
      },
      {
        title: "Website",
        url: "https://alejandrocqvd.github.io/CPSC-329-Terminal/",
      },
    ],
    images: [
  ...
  dinodb: {
    ...
    links: [{ title: "GitHub", url: "https://github.com/e-woo/dinodb" }],
    images: [
  ...
  sortingVisualizer: {
    ...
    links: [
      {
        title: "GitHub",
        url: "https://github.com/alejandrocqvd/Sorting-Algorithm-Visualizer",
      },
      {
        title: "Website",
        url: "https://alejandrocqvd.github.io/Sorting-Algorithm-Visualizer/",
      },
    ],
    images: ["/work/sorting-visualizer-img.PNG"],
  ...
  mihistoria: {
    ...
    links: [
      {
        title: "GitHub",
        url: "https://github.com/alejandrocqvd/MiHistoria",
      },
      {
        title: "Website",
        url: "https://mihistoria.vercel.app/",
      },
    ],
    images: [
  ...
  top: {
    ...
    small: [
      ...
      },
      {
        ...
        side: "right",
        fade: "fade-in-3",
        project: projects.malwareTerminal,
      },
    ],
  },
  bottom: {
    small: [
      ...
      },
      {
        ...
        side: "left",
        fade: "fade-in-5",
        project: projects.sortingVisualizer,
      },
    ],
    large: {
      title: "MiHistoria",
      ...
      side: "right",
      fade: "fade-in-6",
      project: projects.mihistoria,
    },
  },
};

// ==============================================================================================================
function FeaturedProject({ onProjectClick }) {
  return (
    <section className="flex flex-col md:flex-row justify-center items-center w-full mt-32 md:mt-44 px-8 md:px-0">
      <FeaturedProjectContent onProjectClick={onProjectClick} />
...
// ==============================================================================================================
function FeaturedProjectContent({ onProjectClick }) {
  return (
    <div className="flex flex-col justify-center items-start md:mr-9 flex-1 basis-1/2">
      ...
      <div className="flex flex-row justify-between items-start w-full mb-8">
        <p className="text-justify fade-up-first">
          Mixed reality app that lets users to visualize and plan out their
          living spaces with life-sized 3D furniture models, in real time.
        </p>
      </div>

      <FeaturedProjectActions onProjectClick={onProjectClick} />
    </div>
  );
}

// ==============================================================================================================
function FeaturedProjectActions({ onProjectClick }) {
  return (
...
// ==============================================================================================================
function SmallCard({ title, subtitle, img, onClick, side, fade = "" }) {
  const sideClasses =
    side === "left"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center md:items-start px-4 md:px-6 md:pb-1 bg-black/30 h-[50%] md:h-[45%]">
        <p className="font-mono text-lg md:mb-1 text-center md:text-left">
          {title}
        </p>
...
// ==============================================================================================================
function LargeCard({ title, subtitle, img, onClick, side, fade = "" }) {
  return (
    <div
      onClick={onClick}
      className={`border border-white/20 group flex flex-col rounded-md h-96 w-full overflow-hidden cursor-pointer ${fade}
        ${
          side === "left"
            ? "rounded-l-none md:rounded-l-md border-l-0 md:border-l"
            : side === "right"
              ? "rounded-r-none md:rounded-r-md border-r-0 md:border-r"
              : ""
        }`}
    >
...
// ==============================================================================================================
function ProjectBentoBox({ onProjectClick }) {
  return (
    <section className="w-full flex flex-col justify-center items-center mt-24">
      <ProjectBentoTopRow onProjectClick={onProjectClick} />
      <ProjectBentoBottomRow onProjectClick={onProjectClick} />
    </section>
  );
}

// ==============================================================================================================
function ProjectBentoTopRow({ onProjectClick }) {
  return (
    <div className="w-full flex flex-row gap-8">
      <div className="w-2/3">
        <LargeCard
          {...projectCards.top.large}
          onClick={() => onProjectClick(projectCards.top.large.project)}
        />
      </div>

      <div className="flex flex-col justify-between w-1/3 gap-8">
        {projectCards.top.small.map((card) => (
          <SmallCard
            key={card.title}
            {...card}
...
// ==============================================================================================================
function ProjectBentoBottomRow({ onProjectClick }) {
  return (
    <div className="w-full flex flex-row gap-8 mt-8">
      <div className="flex flex-col justify-between w-1/3 gap-8">
        {projectCards.bottom.small.map((card) => (
          <SmallCard
            key={card.title}
            {...card}
            onClick={() => onProjectClick(card.project)}
      ...
      <div className="w-2/3">
        <LargeCard
          {...projectCards.bottom.large}
          onClick={() => onProjectClick(projectCards.bottom.large.project)}
        />
      </div>
    </div>
  );
