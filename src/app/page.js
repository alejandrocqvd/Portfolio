...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div id="home"></div>
      <div className="flex flex-col justify-center items-center text-center w-screen md:w-full h-screen landing-page-bg bg-cover bg-no-repeat">
      ...
      <div id="about" className="relative -top-40 -z-10 h-32 md:h-40"></div>
      <WhoAmISection />
