  ...
  return (
    <>
      <section className="flex flex-col justify-center items-center mt-32 md:mt-44 w-full mx-auto max-w-4xl px-6">
        <h2 className="font-mono text-left mx-auto w-full text-4xl mb-8">
          Get In Touch
        </h2>

        <p className="text-sm text-left w-full mb-12 text-muted-foreground">
          ...
          <div className="md:w-3/5 h-full flex flex-col justify-between">
            {contactLinks.map((link) => (
              <a
                ...
                className="group flex flex-1 items-center justify-between px-3 border-t border-border last:border-b transition-colors hover:bg-secondary/30"
              >
