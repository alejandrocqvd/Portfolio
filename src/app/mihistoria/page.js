export default function MiHistoria() {
  return (
    <div className="w-full justify-center items-center">
      <div className="flex flex-col justify-center items-center w-8/12 m-auto my-16">

        <h1 className="font-bold text-6xl text-center mb-10 bg-clip-text text-transparent bg-gradient">MiHistoria</h1>
        ...
        <img 
          src="/mihistoria-img.png" 
          alt="MiHistoria Landing Page"
          className="h-auto w-10/12 white-box-shadow rounded-xl my-10"
        /> */}

        <div className="flex flex-row justify-center items-center">
          <p className="flex-1 text-lg mr-6">
