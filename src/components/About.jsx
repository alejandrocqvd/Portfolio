...
const WhoAmISection = () => {
  ...
  return (
    <div className="w-full h-full relative pt-36 -top-36">
      <section ref={ref} className={`pt-10 relative -top-36 ${inView ? 'section-visible' : 'section-hidden'}`}>
        ...
        <div className="flex flex-col xl:flex-row justify-center items-center w-9/12 xl:w-8/12 max-w-7xl">
          <img src="/about/portrait.png" className="h-[28rem] w-auto md:w-3/4 xl:w-auto object-cover white-box-shadow xl:flex-1 mb-10 xl:mb-0 xl:mr-8" alt="Portrait" />
